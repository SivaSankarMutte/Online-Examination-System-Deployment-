<%-- 
    Document   : accessTestQuestionTimeLimit
    Created on : 15 Mar, 2022, 8:29:22 PM
    Author     : SIVASANKAR
--%>
	...
	<sql:setDataSource var="db" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/demo2?useSSL=false&allowPublicKeyRetrieval=true" user="siva" password="0000"/>
        ...
        <script type="text/javascript">     
            ...
            var x = setInterval(function() {
              ...
              if (distance < 0) {
                clearInterval(x);
                window.location.replace("http://34.203.225.61:8080/Exam/calculateMarksForAStudent");
              }
            }, 1000);
        ...
        <div style="background-color:white; margin:0; width:100%;height:100%;">
            <button id="go-button" onclick="fun1()" class="btn btn-success form-control">Start Exam</button>
             <center>
                <p id="demo" class="bg-success rounded text-center" style="width:125px; color: black; position: static;">Timer</p>
            </center>
            <iframe id="frame" style="height: 800px; width: 100%;display: none;" src="accessTestQuestionTimeLimitDisplay1.jsp" title="Questions" class="responsive-iframe"></iframe>
        </div>
		</c:when>
